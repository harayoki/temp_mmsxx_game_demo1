...
const DEFAULTS = {
  ...
  //
  // 5 から 8 へ広げてある。**すぐ全速まで出るようにしたぶん**、
  // 原点のすぐそばで向きが立つと、わずかな震えが全速の向き違いになる
  // (下の stickFullDist を見ること)
  deadzone: 8,
   ...
   *
   * **14 = 不感帯のすぐ外で全速。** 0(絵の大きさ任せ)だと手元の端末で
   * 73px になり、指を 20px 動かしても強さが 0.22 にしかならなかった。
   * 自機が指のうしろを追ってくるので、**慣性が付いているように感じる**。
   * 避けゲーで欲しいのは「動かしたぶんだけ即座に動く」ことなので、
   * ここは刻みを捨てて、触れたら全速まで出るほうを取る。
   * 刻みが欲しくなったら 40〜70 あたりまで戻せば、また指なりになる
   */
  stickFullDist: 14,
