...
export const ICONS = {
  ...
  // 画面を 180 度回す。**枠の中に U ターンの矢印**。
  // 90 度は要らない(縦横は engine/video.js が勝手に合わせる)ので、
  // 向きの数字は描かない。「回して戻ってくる」形だけで足りる
  rotate180: [
    '................',
    '.##############.',
    '.#............#.',
  ...
  // 効きぐあい(十字の敏感さ)。**低い順に伸びる 3 本の棒**。
  // 段そのものは棒の数では見せない(押すたびに画面へ文字で出る)。
  // ここでは「強さを段で選ぶもの」だと分かればよい
  sensitivity: [
    '................',
    '................',
    '.............++.',
